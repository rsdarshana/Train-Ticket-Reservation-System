...
import com.trainsystem.services.ScheduleService;
...
public class ScheduleController {
    ...
    public String viewSchedules(@AuthenticationPrincipal UserDetails userDetails, Model model) {
        try {
            ...
            List<TrainSchedule> schedules = scheduleService.getAllSchedules();
    ...
    public String applyFilter(@AuthenticationPrincipal UserDetails userDetails,
        ...
        try {
            ...
            List<TrainSchedule> filteredSchedules = scheduleService.getFilteredSchedules(
    ...
    public String saveFilterPreferences(@AuthenticationPrincipal UserDetails userDetails,
        ...
        if (userDetails != null) {
            try {
                scheduleService.saveFilterPreferences(userDetails.getUsername(), filter);
    ...
    public String viewTrainSchedule(@PathVariable String trainNumber,
        ...
        try {
            ...
            List<TrainSchedule> schedules = scheduleService.getSchedulesByTrainNumber(trainNumber);
